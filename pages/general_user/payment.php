...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST["bkash_submit"])) {
        // Logic for BKash payment

        header("Location:club_forum.php");
    } elseif (isset($_POST["nagad_submit"])) {
        // Logic for Nagad payment
        // Add your Nagad payment logic here
        // ...
                    ...
                    <div class="card-header">
                            ...
                            <div id="credit-card" class="tab-pane fade show active pt-3">
                                ...
                                <form action="confirm_payment.php" method="POST">
                                    <div class="form-group">
                                        <label for="username">
                                            <h2 style="margin-bottom: 5%;">Payment Amount : 500৳ <? php // echo $amount 
                                                                                                    ?></h2>
                                            <h6>BKash Number</h6>
                                        </label>
                                    ...
                                    <div class="card-footer">
                                        <button type="submit" name="bkash_submit" class="w-100 subscribe btn btn-cus btn-block shadow-sm"> Confirm Payment </button>
                                        <button onclick="location.href = 'club_forum.php';" type="button" class="w-100 subscribe btn btn-cus2 btn-block shadow-sm"> Cancel Payment & Return Home</button>
                                    </div>
                                </form>
                        ...
                        <div id="paypal" class="tab-pane fade">
                            ...
                            <form action="confirm_payment.php" method="POST">
                                ...
                                <div class="card-footer">
                                    <button type="submit" name="nagad_submit" class="w-100 subscribe btn btn-cus btn-block shadow-sm"> Confirm Payment </button>
                                    <button onclick="location.href = 'club_forum.php';" type="button" class="w-100 subscribe btn btn-cus2 btn-block shadow-sm"> Cancel Payment & Return Home</button>
                                </div>
                            </form>
                        </div> <!-- End -->
