                                            ...
                                            <div class="card p-1" style="min-width: 400px !important; <?php if (file_exists("../uploads/" . $post_row['img'])) {
                                                ...
                                                <div class="shadow-desc">
                                                    <div class="blog-meta">
                                                        ...
                                                        <h4 style="text-align: justify;"><a id="view" class="text-uppercase fw-bold" href="view.php?id=<?php echo $post_row["id"]; ?>" title="<?php echo $post_row["title"]; ?>" target="_blank"><?php echo $post_row["title"]; ?></a></h4>
